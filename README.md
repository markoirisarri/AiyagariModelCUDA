...
* Visual Studio 2019 or 2022
  ...
  * Please make sure that the build target is set to your CUDA Toolkit version. By default, it is set to CUDA Toolkit version 12.3. It can be changed in project settings > CUDA C/C++ > CUDA Toolkit Custom Dir and specifying the path to your CUDA Toolkit. (By default it should be at "C:\Program Files\NVIDIA GPU Computing Toolkit\CUDA\vxx.x")
* Nvidia Graphics Drivers
  * Will be often installed or updated as part of the CUDA toolkit

## Useful References

* CUDA Best Practices [link](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/index.html)
* CUDA Documentation [link](https://docs.nvidia.com/cuda/)
* CUDA Sample Codes [link](https://github.com/NVIDIA/cuda-samples)
